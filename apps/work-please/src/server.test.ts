...
function makeRunningEntry(overrides: Partial<RunningEntry> = {}): RunningEntry {
  return {
    identifier: 'TEST-1',
    issue: { id: 'issue-1', identifier: 'TEST-1', title: 'Test issue', description: null, priority: 1, state: 'In Progress', branch_name: null, url: null, assignees: [], labels: [], blocked_by: [], pull_requests: [], review_decision: null, created_at: null, updated_at: null },
    session_id: 'sess-1',
