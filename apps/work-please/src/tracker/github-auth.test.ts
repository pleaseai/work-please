...
function makeConfig(tracker: Partial<ServiceConfig['tracker']>): ServiceConfig {
  return {
    ...
    claude: { model: null, command: 'claude', permission_mode: 'bypassPermissions', allowed_tools: [], turn_timeout_ms: 3_600_000, read_timeout_ms: 5_000, stall_timeout_ms: 300_000 },
    server: { port: null },
  }
}
