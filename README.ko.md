...
이 프로젝트는 [Claude Agent SDK](https://github.com/anthropics/claude-agent-sdk-typescript)를 사용하며,
Anthropic의 [상업적 서비스 약관](https://www.anthropic.com/legal/commercial-terms)이 적용됩니다.
