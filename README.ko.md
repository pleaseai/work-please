...
Please Work는 이슈 트래커의 작업을 격리된 자율 구현 실행으로 전환합니다 — 코딩 에이전트를 감독하는 대신 작업을 관리합니다.

> **경고**: Please Work는 신뢰할 수 있는 환경에서 사용하기 위한 엔지니어링 프리뷰입니다.
...
Please Work는 다음을 수행하는 장기 실행 TypeScript 서비스입니다:
...
# 현재 디렉토리의 WORKFLOW.md를 사용하여 Please Work 실행
bunx please-work
...
`WORKFLOW.md`는 Please Work의 런타임 동작에 대한 단일 진실 공급원입니다. YAML front matter
...
workspace:
  root: ~/please-work_workspaces        # 선택: 기본값 <tmpdir>/please-work_workspaces
...
claude:
  ...
  settings:
    attribution:
      commit: "🙏 Generated with [Please Work](https://github.com/pleaseai/work)"  # 선택: git 커밋 메시지에 추가. 기본값은 Please Work 링크.
      pr: "🙏 Generated with [Please Work](https://github.com/pleaseai/work)"      # 선택: PR 설명에 추가. 기본값은 Please Work 링크.
...
Please Work는 시작 시 GitHub App 설정을 검증합니다:
...
Please Work는 Claude Code를 자율적으로 실행합니다. 배포 전에 신뢰 관련 영향을 이해하세요.
...
- Please Work는 OpenAI의 [Symphony 명세](vendor/symphony/SPEC.md) (Apache 2.0)를 기반으로 한 TypeScript 구현체입니다.
